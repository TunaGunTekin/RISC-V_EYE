...
HD_PWD='/home/tuna-gun/GradProject/RISC-V_EYE/RISC-V_EYE_Pipelined_Core/RISC-V_EYE_Pipelined_Core.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_top_eye.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_top_eye.tcl -notrace
